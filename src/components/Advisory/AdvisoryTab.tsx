...
import { Shield, Smartphone, Database, Code, CreditCard, LineChart, Lock, Globe, ChevronRight, ChevronDown, ChevronUp } from 'lucide-react';
...
// Type definitions
type TabKey = 'Fraud Red Teaming' | 'Open banking Security' | 'ATM security Assessment' | 'IoT Security for Banking & Finance';
...
const contentByTab: Record<TabKey, TabContent> = {
  'Fraud Red Teaming': {
    offerings: [
      {
...
const tabHeaders: Record<TabKey, TabHeader> = {
  'Fraud Red Teaming': {
...
export default function AdvisoryTab() {
  ...
  const [expandedOfferings, setExpandedOfferings] = useState<{[key: string]: number}>({});
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {contentByTab[activeTab].offerings.map((offering: Offering, index: number) => (
                  <div
                    key={index}
                      ...
                      >
                        <div className="flex items-center space-x-3 md:space-x-4">
                          <div>
                           ...
                           {expandedOfferings[activeTab] === index ? (
                             ...
                             <ChevronDown className="w-5 h-5 md:w-6 md:h-6" />
                                             ...
                                             {/* Accordion Content */}
                       {expandedOfferings[activeTab] === index && (
                        <div className="px-4 md:px-6 pb-4 md:pb-6 bg-black">
          ...
          <div key={tab} className="w-full">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {contentByTab[tab].offerings.map((offering: Offering, index: number) => (
                      ...
                      >
                        <div className="flex items-center space-x-4">
                         ...
                         className={`transition-all duration-300 ${
                           expandedOfferings[activeTab] === index ? 'max-h-[200px] opacity-100' : 'max-h-0 opacity-0'
                         } overflow-hidden`}
                       >
                        <div className="p-4">
