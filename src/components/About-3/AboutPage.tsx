...
import herovideo from '../../assest/image/about/center.mp4'
...
<div className="relative w-full h-screen flex items-center justify-center">
  ...
  {/* Hero content - now centered single column */}
  <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-white">
    <h1 className="text-3xl md:text-5xl  text-center   font-bold text-white mb-8">About Us</h1>
    
    <div className="space-y-4 text-center">
      <div>
        <h2 className="text-4xl lg:text-6xl 2xl:text-7xl text-center   font-bold text-white ">Relentless In Defense.</h2>
      </div>
      
      <div>
        <h2 className="text-4xl lg:text-6xl 2xl:text-7xl text-center   font-bold text-white">Human In Approach.</h2>
      </div>
      
      <div>
        <h2 className="text-4xl lg:text-6xl 2xl:text-7xl text-center   font-bold text-white">Global In Reach.</h2>
      </div>
    </div>
  </div>
</div>
